...
def excelOutput(excelFilename, sheet, class_type = "PixelLocation"):
    ...
    fileOutput = fileOutput + "_TESTTTTExcel.xls"
...
letter_reshape = letter.reshape(letter.shape[0],-1)
# print("Reshaping to 2D array:",
#         imageMat_reshape.shape)

mat_df = pd.DataFrame(letter_reshape)

# exporting dataframe to CSV file.
mat_df.to_csv('TESTFILE.csv',
              header = None,
              index = None)
