...
#Pin connections initially made while Breadboarding
print("starting up")
...
# Set motor frequencies #was 1000Hz, based on WSU student's intuition
#changed to 250Hz, based on reseach claiming it to be most optimal - both freq. worked fine.
motor1.freq(250)
motor2.freq(250)
motor3.freq(250)
motor4.freq(250)
...
# UART over BLE class
class BLEUART:
  def __init__(self, ble, name="Haptic Sleeve ML", rxbuf=100):
    self._ble = ble
