...
letter_array = cv2.imread(filename, 1)
#controls whether the excel file will have 0s
fillEmptyWithZeros = True
print(type(letter_array))
# letter_array2 = np.array(letter_array, dtype=np.uint8)
# print(type(letter_array2))
df = pd.DataFrame(letter_array)
#print(type(df))
#
...
#     fileOutput = fileOutput + "Excel.xlsx"
#
